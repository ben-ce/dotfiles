...
local empty_notifbox = require("ui.panel.notification-panel.notif-center.build-notifbox.empty-notifbox")
local notifbox_scroller = require("ui.panel.notification-panel.notif-center.build-notifbox.notifbox-scroller")
...
local notifbox_add = function(n, notif_icon, notifbox_color)
	...
	local notifbox_box = require("ui.panel.notification-panel.notif-center.build-notifbox.notifbox-builder")
...
naughty.connect_signal("request::display", function(n)
	...
	if not notif_icon then
		notif_icon = beautiful.theme_assets.awesome_icon(24, beautiful.colors.sapphire, beautiful.widget_bg)
	end
