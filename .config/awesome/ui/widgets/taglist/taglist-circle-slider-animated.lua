...
-- |_   _|_ _  __ _| (_)___| |_    __ _ _ __ (_)_ __ ___   __ _| |_ ___  __| |   ___(_)_ __ ___| | ___
--   | |/ _` |/ _` | | / __| __|  / _` | '_ \| | '_ ` _ \ / _` | __/ _ \/ _` |  / __| | '__/ __| |/ _ \
--   | | (_| | (_| | | \__ \ |_  | (_| | | | | | | | | | | (_| | ||  __/ (_| | | (__| | | | (__| |  __/
--   |_|\__,_|\__, |_|_|___/\__|  \__,_|_| |_|_|_| |_| |_|\__,_|\__\___|\__,_|  \___|_|_|  \___|_|\___|
--            |___/
...
local s_rgb = color.color({ hex = beautiful.taglist_slidey_color, disable_hsl = true }) --slidey color
...
local function draw_slidey_thing(cr, height, xpos)
	cr:arc(xpos, height / 2, dpi(15), 0, math.pi * 2)
	cr:fill()
end
